    ...
    <section className="relative min-h-[93vh] flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 relative z-10 pointer-events-none">
        <div className="max-w-4xl mx-auto text-center pointer-events-auto">
          ...
          >
            పత్తిపాటి రమేష్ నాయుడు <span className="text-white/80">రచనలు</span>
          </motion.h1>
          ...
          >
            Explore a curated collection of PDF documents written with love and
            wisdom. Each document is a journey through thoughts, stories, and
            life lessons meant to inspire and enlighten.
          </motion.p>
          ...
          >
            <Button
              asChild
              size="lg"
              className="group text-base px-8 bg-white text-black hover:bg-white/90"
            >
              <Link to="/library">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="text-base px-8 border-white/20 bg-white/90 text-black"
            >
